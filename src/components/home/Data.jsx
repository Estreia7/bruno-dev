...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Bruno<svg
                width="36"
                height="36"
                viewBox="0 0 48 48"
                fill="none"
            ...
            <p className="home__description">I'm a curious and passionate programmer based in Portugal, and I'm looking for my oportunity in the market.</p>
